          ...
          <v-card class="elevation-2">
            ...
            <v-card-text>
              <v-form v-if="!editing" class="contact-details">
                <v-row>
                  <v-col cols="12" md="6">
                    <v-text-field label="Nome" v-model="contact.firstName" :rules="[
                ...
                (v) =>
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field label="Sobrenome" v-model="contact.lastName" :rules="[
                (v) =>
                  !v ||
                  v.length <= 20 ||
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field label="Email" v-model="contact.email" :rules="[
                (v) => !!v || 'Campo Email é obrigatório',
                (v) => /.+@.+/.test(v) || 'Email deve ser válido',
              ]" readonly></v-text-field>
                  </v-col>
                  <v-col cols="12" md="6">
                    <v-text-field label="Telefone" v-mask="'(##) #####-####'" v-model="contact.telephone" :rules="[
                ...
                (v) =>
                  ...
                  <v-col cols="12">
                    <v-text-field label="Categoria" v-model="contact.category" :rules="[
              ...
              <v-form v-else>
                <v-row>
                  <v-col cols="12" md="6">
                    <v-text-field label="Nome" v-model="editedData.firstName" :rules="[
                (v) => !!v || 'Campo Nome é obrigatório',
                (v) =>
                  (v && v.length <= 20) ||
                  'Nome deve ter no máximo 20 caracteres',
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field label="Sobrenome" v-model="editedData.lastName" :rules="[
                (v) =>
                  !v ||
                  v.length <= 20 ||
                  'Sobrenome deve ter no máximo 20 caracteres',
                  ...
                  <v-col cols="12" md="6">
                    <v-text-field label="Email" v-model="editedData.email" :rules="[
                (v) => !!v || 'Campo Email é obrigatório',
                (v) => /.+@.+/.test(v) || 'Email deve ser válido',
              ]"></v-text-field>
                  </v-col>
                  <v-col cols="12" md="6">
                    <v-text-field label="Telefone" v-mask="'(##) #####-####'" v-model="editedData.telephone" :rules="[
                (v) => !!v || 'Campo Telefone é obrigatório',
                (v) =>
                  (v.match(/\d/g) || []).length === 11 ||
                  'Telefone deve conter 11 dígitos numéricos',
                  ...
                  <v-col cols="12">
                    <v-text-field label="Categoria" v-model="editedData.category" :rules="[
                (v) => !!v || 'Campo Categoria é obrigatório',
                (v) =>
                  (v && v.length <= 50) ||
                  'Categoria deve ter no máximo 50 caracteres',
            ...
            <v-alert v-if="errorMessage" :value="errorMessage" type="error" dismissible>
              {{ errorMessage }}
            </v-alert>
          </v-card>
        </v-col>
