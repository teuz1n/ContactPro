      ...
      <v-row>
        <v-col cols="12" md="6">
          <v-card class="dashboard-card graph-card">
            <v-card-title class="dashboard-title"
              >Evolução dos Contatos por Mês</v-card-title
            >
        ...
        <v-col cols="12" md="6">
          <v-card class="dashboard-card contact-card">
            <v-card-title class="dashboard-title"
              >Informações de Contatos</v-card-title
            >
            <v-card-text>
...
export default {
  ...
  methods: {
    fetchRelatorioEstatistico() {
      ...
      axios
        .get("http://localhost:4080/api/report", config)
        .then((response) => {
          this.totalContatos = response.data.totalContatos;
          this.totalContatosUltimas12Horas =
            response.data.totalContatosUltimas12Horas;
